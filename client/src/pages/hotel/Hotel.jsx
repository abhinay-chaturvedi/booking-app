      ...
      <div className="hotelContainer">
        {
          open && <div className="slider">
            ...
            <FontAwesomeIcon onClick={()=>handleArrow("d")}  className="arrow" icon={faCircleArrowLeft}/>
            <div className="sliderWrapper">
              <img src={photos[slideNumber].src} alt="" className="sliderImg" />
            </div>
            <FontAwesomeIcon onClick={()=>handleArrow("i")}  className="arrow" icon={faCircleArrowRight}/>
          </div>
        }
        <div className="hotelWrapper">
          ...
          <span className="hotelDistance">
            Excellent location from 500 from center
          </span>
